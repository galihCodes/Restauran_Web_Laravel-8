...
<body>
    <div class="container">
            <a href="/restauran/pembayaran"><img src="/admin/icon/restaurant.png" onclick="return confirm('Kembali ke Pembayaran?')" alt="" style="width: 10rem; height: 10rem; margin-bottom: 2rem; margin-top: 2rem; " class="rounded mx-auto d-block"></a>
